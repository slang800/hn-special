...
HNSpecial.settings.registerModule("visual_theme", function () {
  ...
  if (ignore.indexOf(location.pathname) === -1) {
    ...
    if (logo) {
      ...
      logo.setAttribute("src", HNSpecial.browser.getUrl("resources/logo.svg"));
    }
  ...
  function replaceArrows() {
    ...
    var upArrow = HNSpecial.browser.getUrl(isDark ? "resources/arrow-up-white.svg" : "resources/arrow-up-black.svg");
    var downArrow = HNSpecial.browser.getUrl(isDark ? "resources/arrow-down-white.svg" : "resources/arrow-down-black.svg");
    var arrowPicture;
